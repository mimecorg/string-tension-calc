...
export const PACKS = [
	{gauges: ['.009 P', '.011 P', '.016 P', '.026 W', '.036 W', '.046 W'], name: "Ernie Ball 2222 Hybrid Slinky 9-46"},
	{gauges: ['.0095 P','.012 P', '.016 P', '.024 W', '.034 W', '.044 W'], name: "Ernie Ball 2212 Primo Slinky 9.5-44"},
	{gauges: ['.0095 P','.012 P', '.016 P', '.026 W', '.036 W', '.046 W'], name: "Ernie Ball 2224 Turbo Slinky 9.5-46"},
	{gauges: ['.010 P', '.013 P', '.017 P', '.026 W', '.036 W', '.046 W'], name: "Ernie Ball 2221 Regular Slinky 10-46"},
	{gauges: ['.010 P', '.013 P', '.017 P', '.028 W', '.038 W', '.048 W'], name: "Ernie Ball 2227 Ultra Slinky 10-48"},
	{gauges: ['.010 P', '.013 P', '.017 P', '.030 W', '.042 W', '.052 W'], name: "Ernie Ball 2215 Heavy Bottom 10-52"},
	{gauges: ['.011 P', '.014 P', '.018 P', '.028 W', '.038 W', '.048 W'], name: 'Ernie Ball 2220 Power Slinky 11-48'},
	{gauges: ['.011 P', '.014 P', '.018 P', '.030 W', '.040 W', '.052 W'], name: 'Ernie Ball 2226 Burly Slinky 11-52'},
	{gauges: ['.011 P', '.015 P', '.022 W', '.030 W', '.042 W', '.052 W'], name: 'Ernie Ball 2208 Light Gauge 11-52'},
	{gauges: ['.011 P', '.015 P', '.022 P', '.030 W', '.042 W', '.054 W'], name: 'Ernie Ball 2627 Beefy Slinky 11-54'},
	{gauges: ['.012 P', '.016 P', '.024 P', '.032 W', '.044 W', '.054 W'], name: 'Ernie Ball 2206 Medium Light 12-54'},
	{gauges: ['.012 P', '.016 P', '.024 P', '.032 W', '.044 W', '.056 W'], name: 'Ernie Ball 2626 Not Even Slinky 12-56'},
	{gauges: ['.012 P', '.016 P', '.022 W', '.032 W', '.044 W', '.056 W'], name: 'Ernie Ball 2618 Magnum Slinky 12-56'},
	{gauges: ['.013 P', '.017 P', '.026 W', '.034 W', '.046 W', '.056 W'], name: 'Ernie Ball 2204 Medium Gauge 13-56'},
	{gauges: ['.013 P', '.018 P', '.030 W', '.044 W', '.056 W', '.072 W'], name: 'Ernie Ball 2839 Baritone Slinky 13-72'},
...
export const TUNINGS = [
	...
	{name: 'Drop A',  notes: ['B3', 'F#3','D3', 'A2', 'E2', 'A1', 'E1', 'B1' ]},
] as const;
